...
namespace Parkview.Migrations
{
    ...
    [Migration("20230908062758_Migration3")]
            ...
            modelBuilder.Entity("Parkview.Models.Destination", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            DestinationId = 2,
                            DestLocationId = 2,
                            DestinationDescription = "Tourists flock to the Gateway of India to admire its Indo-Saracenic architecture and relive the city's colonial past with ParkView Maharashtra.",
